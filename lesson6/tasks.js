...
arrNumbers.map(value => console.log(arrNumbers.toString()));
...
// - знайти піковий туз
let spadeAce = deckOfCards.filter(card => card.cardSuit === 'spade' && card.value === 'ace' && card.color === 'black');
console.log(spadeAce);
// - всі шістки
let allSix = deckOfCards.filter(card => card.value === '6');
console.log(allSix);
// - всі червоні карти
let allRedCards = deckOfCards.filter(card => card.color === 'red');
console.log(allRedCards);
// - всі буби
let allDiamond = deckOfCards.filter(card => card.cardSuit === 'diamond');
console.log(allDiamond);
// - всі трефи від 9 та більше
let allClubsBiggerNine = deckOfCards.filter(card => card.cardSuit === 'clubs' && card.value !== '6' && card.value !== '7' && card.value !== '8' && card.value !== '9');
console.log(allClubsBiggerNine);
//
// {
...
//     clubs:[]
// }
let newCardSuit = deckOfCards.reduce((accumulator, card) => {
